package top.renk.tvtopbox.widget;
        ...
        if (focusView != null) {
            ...
            switch (event.getKeyCode()) {
                case KeyEvent.KEYCODE_DPAD_RIGHT:
                    Log.e("renk", "CustomRecyclerView.KEYCODE_DPAD_RIGHT.");
                    if (event.getAction() == KeyEvent.ACTION_UP) {
                        return true;
                    } else {
                        View rightView = FocusFinder.getInstance().findNextFocus(this, focusView, View.FOCUS_RIGHT);
                        Log.e("renk", "rightView is null:" + (rightView == null));
                        if (rightView != null) {
                            Log.e("renk", "CustomRecyclerView.requestFocusFromTouch.");
...
//                    Log.i(this, "left is null:" + (leftView == null));
                    if (event.getAction() == KeyEvent.ACTION_UP) {
                        return true;
                    } else {
                        if (leftView != null) {
...
//        Log.i(this, "CustomRecyclerView.onScrolled.");
    ...
    public boolean isLastItemVisible(int lineNum, int allItemNum) {
        ...
        LayoutManager layoutManager = getLayoutManager();
        if (layoutManager instanceof StaggeredGridLayoutManager) {
//            Log.i(this, "lastVisiblePosition:" + position);
...
//            Log.i(this,"HomeTvAdapter.onBindViewHolder.");
                ...
                public boolean onHover(View v, MotionEvent event) {
                    ...
                    switch (what) {
                        case MotionEvent.ACTION_HOVER_ENTER:
                            ...
                            int x = location[0];
//                            Log.i("swj","GalleryAdapter.onHover.x="+x +",width = "+(recyclerView.getWidth()+x));
                            ...
                            if (recyclerView.getScrollState() == RecyclerView.SCROLL_STATE_IDLE) {
                                ...
                                v.requestFocus();
//                                Log.i(this,"HomeTvAdapter.onHover.position:"+position);
